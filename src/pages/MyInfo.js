...
export default function MyInfo() {
  ...
  const UserURL = "https://giver.fly.dev/user/login";
  ...
  const handleMyInfoChange = (e) => {
    axios
      .put(`https://giver.fly.dev/${sessionStorage.id}/edit`, {
            ...
            <div className="mb-items">
              {!nameChange ? (
                <div className="mb-name">
                  <div>{name}</div>
                  <button onClick={(e) => setNameChange(true)}>
                    닉네임 변경
                  </button>
                </div>
              ) : (
        ...
        {!addressChange ? (
          <div className="mb-contents">
            ...
            <div className="mb-address-btns">
              <button onClick={(e) => setAddressChange(true)}>수정</button>
            </div>
          </div>
        ) : (
          <div className="mb-contents">
